            ...
            <div className="lg:col-span-6 space-y-8 order-1">
              <div className="space-y-4 animate-mask-reveal">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[10px] font-black tracking-[0.6em] uppercase text-gold font-heading">Ancestral Transmission</span>
                </div>

                <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.1] tracking-tighter">
                  Vedic Lineage. <br />
                  <span className="text-gold font-serif">Eternal Mastery.</span>
                </h1>
              </div>
              ...
              <div className="space-y-8 animate-fade-up" style={{ animationDelay: '400ms' }}>
                <p className="max-w-xl text-sm lg:text-base text-[#fdfcf6]/50 leading-relaxed font-serif italic-none border-l border-white/10 pl-8">
                  "Guardians of the pristine Vedic tradition. A life dedicated
                  to the vibrational science of Mantra Shastra and the preservation
                  of ancestral wisdom for the digital age."
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
                  <button className="w-full sm:w-auto bg-gold text-black px-10 py-5 rounded-full font-black text-[10px] tracking-widest uppercase hover:bg-white transition-all shadow-2xl flex items-center justify-center gap-4 group font-heading">
                    Connect with Aacharya <ArrowRight size={18} className="group-hover:translate-x-2 transition-transform" />
                  </button>
                  <button className="flex items-center gap-4 group">
                    ...
                    <span className="text-[9px] font-black tracking-widest uppercase text-[#fdfcf6]/40 group-hover:text-gold transition-colors font-heading">Watch Ritual</span>
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/5 animate-fade-up" style={{ animationDelay: '800ms' }}>
                {[
                  { label: "Lineage", val: "Para-Parampara", icon: ShieldCheck },
                  { label: "Science", val: "Mantra Shastra", icon: Activity },
                  { label: "Focus", val: "Vedic Sync", icon: Search }
                ].map((m, i) => (
