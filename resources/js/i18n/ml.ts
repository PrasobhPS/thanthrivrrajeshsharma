...
export const ml: Messages = {
  ...
  consultation: {
    ...
    subtitle: "നിങ്ങളുടെ വിവരങ്ങൾ അയയ്ക്കുക; വഴിപാടുകൾ, മാർഗദർശനം, സേവനങ്ങൾ എന്നിവയിൽ ഞങ്ങൾ ബന്ധപ്പെടും.",
    name: "പൂർണ്ണ പേര്",
    namePlaceholder: "നിങ്ങളുടെ പേര്",
    phone: "ഫോൺ / WhatsApp",
    phonePlaceholder: "രാജ്യ കോഡോടുകൂടിയ മൊബൈൽ നമ്പർ",
    email: "ഇമെയിൽ (ഐച്ഛികം)",
    emailPlaceholder: "you@example.com",
    service: "സേവനം അല്ലെങ്കിൽ വഴിപാട്",
    servicePlaceholder: "നമ്മുടെ സേവനങ്ങളിൽ നിന്ന് തിരഞ്ഞെടുക്കുക",
    serviceOther: "മറ്റുള്ളത് — താഴെ വിവരിക്കുക",
    otherService: "അഭ്യർത്ഥിച്ച സേവനം",
    otherServicePlaceholder: "ഉദാ. സ്വകാര്യ കൺസൾട്ടേഷൻ, പ്രത്യേക പൂജ",
    preferredDate: "ഇഷ്ടപ്പെട്ട തീയതി (ഐച്ഛികം)",
    message: "സന്ദേശം (ഐച്ഛികം)",
    messagePlaceholder: "സമയം, സ്ഥലം, ചോദ്യങ്ങൾ…",
    submit: "അന്വേഷണം അയയ്ക്കുക",
    submitting: "അയയ്ക്കുന്നു…",
    success: "നന്ദി. നിങ്ങളുടെ അന്വേഷണം ലഭിച്ചു — ഞങ്ങൾ ഉടൻ ബന്ധപ്പെടും.",
    errorGeneric: "എന്തോ തെറ്റായി. വീണ്ടും ശ്രമിക്കുക.",
    requiredHint: "* അടയാളപ്പെടുത്തിയ ഫീൽഡുകൾ നിർബന്ധമാണ്.",
  },
};
